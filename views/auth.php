  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="form-container">
        <form class="form-horizontal" action="/userAction/auth" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              ...
              <br><br>
              Нет аккаунта? <a href="/userAction/reg">Зарегистрируйтесь</a>
            </div>
              <?php
              echo "<div class=''>{$data['message']}</div>"
              ?>
          </div>
        </form>
